...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario(0L, 
			"Jéssica G Prandini", "jessicagpra@email.com", "82716354", "https://i.imgur.com/yDRVeK7.jpg"));
	...
	public void naoDeveDuplicarUsuario() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, 
				"Boris G Prandini", "boris@email.com","82716354", "https://i.imgur.com/JR7kUFU.jpg"));
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<Usuario> usuarioCadastrado = usuarioService.cadastrarUsuario(new Usuario(0L, 
			"Tesla G", "tesla@email.com.br", "456123", "https://i.imgur.com/JR7kUFU.jpg"));
		/**
		...
		Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get().getId(), 
			"Kyra Linda", "kyra@email.com.br", "kyra123" , "https://i.imgur.com/yDRVeK7.jpg");
	...
	public void deveMostrarTodosUsuarios() {
		 ...
		 */
		usuarioService.cadastrarUsuario(new Usuario(0L, 
			"Boris Prand ", "borisprand@email.com.br", "456123", "https://i.imgur.com/5M2p5Wb.jpg"));
		
		usuarioService.cadastrarUsuario(new Usuario(0L, 
			"Naruto G", "narutinho@email.com.br", "naruto123", "https://i.imgur.com/Sk5SjWE.jpg"));
	...
	public void deveListarApenasUmUsuario() {
		...
		Optional<Usuario> usuarioBusca = usuarioService.cadastrarUsuario(new Usuario(0L, 
				"Candy G", "candy@email.com.br", "candy12345", "https://i.imgur.com/EcJG8kB.jpg"));
