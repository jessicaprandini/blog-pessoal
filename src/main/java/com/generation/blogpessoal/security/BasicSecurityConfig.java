...
public class BasicSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception{
		...
		* e é possível utilizar eles. */ 
		...
		.and().sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)  /* ^ Define que toda requisição tem começo, meio e fim. 
		* Uma por vez e ajuda a prevenir ataques cibernéticos e invasões com várias requisições de uma forma | Tipo quando expira o token 
