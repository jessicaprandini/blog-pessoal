...
import io.swagger.v3.oas.models.responses.ApiResponse; // Importa você mesmo caso não importe sozinho 
	...
	public OpenAPI springBlogPessoalOpenAPI() { 
		...
		return new OpenAPI() 
			...
			.license(new License() 
				  ...
				  .url("https://brazil.generation.org/")) //Informacoes da empresa
			.contact(new Contact() 
				  .name("Jéssica Prandini") 
				  .url("https://github.com/jessicaprandini") 
				  .email("jessicagprandini@gmail.com"))) 
			.externalDocs(new ExternalDocumentation() 
				  .description("Meu LinkedIn") 
				  .url("https://www.linkedin.com/in/jessicaprandini/"));
	}
